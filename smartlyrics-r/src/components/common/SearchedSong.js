        ...
        return(
            <div className="row">
                <div className="col-lg-10 col-lg-offset-1 col-md-10 col-offset-1 col-sm-12 col-xs-12">
                    <div className="panel">
                        <h3>{this.props.title} <span className="glyphicon glyphicon-align-justify lyricsButton" data-song-id={song_id} data-toggle="modal" data-target="#lyricsModal" aria-hidden="true" data-lyrics-url={this.props.lyrics}></span> <span  onClick = { () => this.props.SetFavorite(song_id) }className={ favClasses }  data-song-id={song_id} aria-hidden="true"></span> </h3>
